...
def ParseArgs():
    ...
    parser.add_argument('--train', help='training data path; If specificed, new model will be trained and output.')
    parser.add_argument('--test', help='test data path; If specificed, prediction will be output to --out_predict.')
    parser.add_argument('--validate', help='float 0~1: portion of validation split from training data; int > 1: number of validation data; validate data should not be more than 30\%')
    parser.add_argument('--in_model', help='load model from path')

    parser.add_argument('--random_seed', help='random seed for training and validation data spliting')
    parser.add_argument('--iter_n', help='number of iteration')
    ...
    parser.add_argument('--beta_m', help='bata value of momentum; The value should be specificed if optimizer is \"adam\".')
    parser.add_argument('--beta_v', help='bata value of velocity; The value should be specificed if optimizer is \"adam\".')
    parser.add_argument('--epsilon', help='The small value for avoiding dividing by zero error while calculating gradient.')
    parser.add_argument('--early_stop', help='early stopping: true or false')

    parser.add_argument('--out_log', help='path of output log file')
    parser.add_argument('--out_model', help='path of output model')
